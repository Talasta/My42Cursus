...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/05/28 13:57:39 by cmaxime           #+#    #+#             */
/*   Updated: 2019/05/29 11:14:08 by cmaxime          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "sha2.h"

static uint64_t	sha512_const_k_extend(size_t idx)
{
	static uint64_t		k[43] = {
...
uint64_t		sha512_const_k(size_t idx)
{
	...
	if (idx < 37)
		return (k[idx]);
	if (idx < 80)
		return (sha512_const_k_extend(idx));
	return (0);
}
